...
class EENWebSocketServer(object):
   ...
   def close(self):
      ...
      #print("To be replaced by logging: closing 1")
      ...
      while True:
         ...
         for ready in wList:
            ...
            try:
               ...
               #print("To be replaced by logging: closing 2")
               client.client.close()
               client.handleClose()
         ...
         for ready in rList:
            if ready == self.serversocket:
               ...
               try:
                  ...
                  #print("To be replaced by logging: closing 3")
                  client.client.close()
                  client.handleClose()
                  del self.connections[ready]
                  self.listeners.remove(ready)
         ...
         for failed in xList:
            if failed == self.serversocket:
               ...
               client.client.close()
               #print("To be replaced by logging: closing 4")
               client.handleClose()
               del self.connections[failed]
               self.listeners.remove(failed)


class EENSSLWebSocketServer(EENWebSocketServer):

   def __init__(self, host, port, websocketclass, certfile,
                keyfile, version = ssl.PROTOCOL_TLSv1, selectInterval = 0.1):

      EENWebSocketServer.__init__(self, host, port,
   ...
   def close(self):
      super(EENSSLWebSocketServer, self).close()
   ...
   def serveforever(self):
      super(EENSSLWebSocketServer, self).serveforever()
